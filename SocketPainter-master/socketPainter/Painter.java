...
public class Painter extends JFrame implements MouseListener, MouseMotionListener, 
	...
	public PaintingPanel paintPanel;
	private JPanel chat;
	private JTextArea msgInput;
	public JTextArea feed;
...
/*======================= this.Event listeners =====================*/
	...
	public synchronized void actionPerformed(ActionEvent e) {
		...
		case "sendMsg":
			...
			if(!this.msgInput.getForeground().equals(Color.LIGHT_GRAY) && !this.msgInput.getText().equals("")) {
				//send input text to feed
				String message = this.msgInput.getText();
